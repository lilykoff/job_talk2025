...
title-slide-attributes:
    data-background-image: figs/koff-talk-qr-url.png
...
plot_grid(p1, p2b, NULL, ncol = 3, align = "v", rel_widths = c(1, 1, 1))
...
- Link to slides: [tinyurl.com/koff-talk](tinyurl.com/koff-talk) 
...
![](figs/koff-talk-qr.png){width=150%}
