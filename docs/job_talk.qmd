...
p2 = ggplot(beta, aes(t, beta)) +
  ...
  labs(title =expression(Coefficient ~ Function ~ hat(beta)(t)), y = "Value", x = "Time") +
  geom_hline(aes(yintercept = 0), linetype = "dashed")+
  annotate(geom = "label", x = 0.3, y = 0.5, label = "Positive values of coefficient\nindicate that higher values of X(t)\nincrease the outcome", size = 4, color = "#444444", vjust = 1) +
...
p3 = ggplot(dfProd, aes(t, prod)) +
  ...
  labs(title = expression(Contribution ~ from ~ Subject ~ 1: ~  X[1]~(t)~x~ hat(β)~(t)),, y = "Value", x = "Time")
...
+ Pipeline to analyze minute-level multivariate hemodynamics data collected during cardiac surgery [@blood]
+ Methods to model relationship between hemodynamics and acute kidney injury [@fine_mapping]
