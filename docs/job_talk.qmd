---
title: "Job Talk"
subtitle: "https://lilykoff.github.io/job_talk2025"
author: "Lily Koffman"
format:
  revealjs:
    theme: custom.scss
...
p3 = p1 + annotate(geom = "rect", xmin = start, xmax = end, ymin = -Inf, ymax = Inf, fill = "#D55E00", alpha = .5) +
  # geom_curve(
  #   aes(x = end, y = 3, xend = end + as.period(5, "minutes"), yend = 6),
...
p3 = p1 + annotate(geom = "rect", xmin = start, xmax = end, ymax = Inf, ymin = -Inf,
  ...
  # geom_curve(
  #   aes(x = end, y = 120, xend = end + as.period(5, "minutes"), yend = 150),
...
steps %>% 
  ...
  annotate(
    ...
    x = 10000,
    y = 1.5,
    label = "Median male steps = 2150",
    hjust = 0,
    color = "#009E73"
  )  +
  geom_segment(
    aes(
      xend = median(steps$total_adeptsteps[steps$gender == "Male"]),
      y = 1.5,
      x = 10000,
      yend = 1.5
    ),
  ...
  annotate(
    ...
    x = 17000,
    y = 6.75,
    label = "Median male steps = 13000",
    hjust = 0,
    color = "#009E73"
  )  +
  geom_segment(
    aes(
      xend = median(steps$total_actisteps[steps$gender == "Male"]),
      y = 6.75,
      x = 17000,
      yend = 7.25
    ),
...
m_ya = median(xdf$total_actisteps[xdf$age_cat == "(18,30]"])
m_child  = median(xdf$total_actisteps[xdf$age_cat == "(0,18]"])
m_old = median(xdf$total_actisteps[xdf$age_cat == "(70,Inf]"])
...
steps %>% 
  ...
  scale_color_viridis_d(option ="B", labels = c("ADEPT", "SSL", "Verisense v2", "Verisense", "RF", "Oak", "Actilife"), name = "Algorithm") +
  ...
  annotate(
    ...
    x = 17000,
    y = 2.5,
    label = "Median steps 19-29 = 12500",
    hjust = 0,
    # fill= "#FCFDBFFF",
    color = "#444444"
  )  +
