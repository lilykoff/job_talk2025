---
title: "Job Talk"
subtitle: "Faculty Job Talk — Johns Hopkins Biostatistics"
author: "Lily Koffman"
format:
  revealjs:
    theme: custom.scss
...
hemo_data = read_csv(here::here("docs", "data", "1156602.csv.gz")) %>% 
...
p3 = p1 + annotate(geom = "rect", xmin = start, xmax = end, ymin = -Inf, ymax = Inf,
            fill = "#F0E442", alpha = .5)
...
```{r hemos plot}
start = as.POSIXct("2022-08-30 16:00:00", tz = "UTC")
...
# accelerometry time series --> scalar predictors 
# fingerprints and application in NHANES - mention R project 
# future directions
# aside - open source step counting? 
# digital fingerprinting 
# step 1: understand data, "fine mapping approach" 
# next: going back to raw data, what can the ABP waveform tell us? 
```
...
Summarizing times in fine-grained ranges of mean arterial pressure and caridac index or central venous pressure 

```{r}
# show some work from the MAP/CVP and MAP/CI papers
